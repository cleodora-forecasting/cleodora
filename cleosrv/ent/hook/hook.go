...
// The OutcomeFunc type is an adapter to allow the use of ordinary
// function as Outcome mutator.
type OutcomeFunc func(context.Context, *ent.OutcomeMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f OutcomeFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.OutcomeMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.OutcomeMutation", m)
}

// The ProbabilityFunc type is an adapter to allow the use of ordinary
// function as Probability mutator.
type ProbabilityFunc func(context.Context, *ent.ProbabilityMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f ProbabilityFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.ProbabilityMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.ProbabilityMutation", m)
}
