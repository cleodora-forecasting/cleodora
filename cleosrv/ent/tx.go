...
func (tx *Tx) init() {
	...
	tx.Outcome = NewOutcomeClient(tx.config)
	tx.Probability = NewProbabilityClient(tx.config)
}
...
// applies a query, for example: Estimate.QueryXXX(), the query will be executed
